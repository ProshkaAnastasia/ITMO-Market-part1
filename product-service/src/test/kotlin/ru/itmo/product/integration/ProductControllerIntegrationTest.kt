...
class ProductControllerIntegrationTest {
    ...
    fun `should return 403 when updating other user product`() {
        val seller1 = testAuthHelper.createTestUser(username = "seller1", email = "seller1@example.com", roles = setOf(
            UserRole.SELLER))
        val seller2 = testAuthHelper.createTestUser(username = "seller2", email = "seller2@example.com", roles = setOf(
            UserRole.SELLER))
